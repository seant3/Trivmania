...
export default function StartGame({data, handleAddPost, category, difficulty, setIsPlaying, loggedUser, handleLogout}) {
    ...
    return (
        <>
            {gameOver ?
                <EndGameDisplay handleLogout={handleLogout} loggedUser={loggedUser} setIsPlaying={setIsPlaying} points={points} handleAddPost={handleAddPost} category={category} difficulty={difficulty}/>
                 :
